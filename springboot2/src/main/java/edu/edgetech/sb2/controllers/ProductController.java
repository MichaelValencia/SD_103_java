...
// codingbat.com register and have fun fam
//ps u better register u moron
//u need practice on problem solving skills
...
public class ProductController {
	...
	public String list(Model model){
		model.addAttribute("myName","Michael Ray Valencia");
		model.addAttribute("catName","socks");
		model.addAttribute("carMake","Honda");
		model.addAttribute("carModel","Civic ex-l");
